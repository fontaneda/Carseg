            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="widget">
                    <div class="widget-body">
                        ...
                        <small class="text-small mt-10 d-block">
                            Registros con novedades detectadas
                        </small>
                    </div>
                    <div class="progress progress-sm">
            ...
            <div class="card-header row">
                ...
                <div class="col col-sm-6">
                    <div class="card-search with-adv-search dropdown">
                        <asp:Label ID="lbl_tablerogrid" runat="server" Text="Ultimas 10 campañas ingresadas">
                        </asp:Label>
                    </div>
                </div>
                <div class="col col-sm-3">
                                ...
                                <div class="item-inner">
                                    ...
                                    <div class="list-title">
                                        <a href="javascript:void(0)">
                                            <asp:Label ID="lbl_tablerogriditm1" runat="server">
                                            </asp:Label>
                                        </a>
                                    </div>
                                    <div class="list-actions">
                                        <a href="#">
                                            <i class="ik ik-edit-2">
                                            </i>
                                        </a>
                                        <a href="#">
